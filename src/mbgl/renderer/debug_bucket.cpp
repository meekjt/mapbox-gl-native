...
gl::VertexBuffer<gl::PlainVertex> buildTextVertexes(const OverscaledTileID& id,
                                                     ...
                                                     gl::Context& context) {
    std::vector<gl::PlainVertex> textPoints;
    ...
    return context.createVertexBuffer(textPoints);
}
...
DebugBucket::DebugBucket(const OverscaledTileID& id,
    ...
    : renderable(renderable_),
      ...
      textVertexes(buildTextVertexes(id, renderable_, complete_, modified_, expires_, debugMode_, context)) {
}
