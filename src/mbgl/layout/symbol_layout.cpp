...
void SymbolLayout::addSymbols(Buffer &buffer, const SymbolQuads &symbols, float scale, const bool keepUpright, const style::SymbolPlacementType placement, const float placementAngle) {
    ...
    for (const auto& symbol : symbols) {
        ...
        buffer.vertexes.emplace_back(anchorPoint.x, anchorPoint.y, tl.x, tl.y, tex.x, tex.y, minZoom,
                            maxZoom, placementZoom, glyphAngle);
        buffer.vertexes.emplace_back(anchorPoint.x, anchorPoint.y, tr.x, tr.y, tex.x + tex.w, tex.y,
                            minZoom, maxZoom, placementZoom, glyphAngle);
        buffer.vertexes.emplace_back(anchorPoint.x, anchorPoint.y, bl.x, bl.y, tex.x, tex.y + tex.h,
                            minZoom, maxZoom, placementZoom, glyphAngle);
        buffer.vertexes.emplace_back(anchorPoint.x, anchorPoint.y, br.x, br.y, tex.x + tex.w, tex.y + tex.h,
                            minZoom, maxZoom, placementZoom, glyphAngle);
    ...
    for (const SymbolInstance &symbolInstance : symbolInstances) {
        for (int i = 0; i < 2; i++) {
            ...
            for (const CollisionBox &box : feature.boxes) {
                ...
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, tl.x, tl.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, tr.x, tr.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, tr.x, tr.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, br.x, br.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, br.x, br.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, bl.x, bl.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, bl.x, bl.y, maxZoom, placementZoom);
                collisionBox.vertexes.emplace_back(anchor.x, anchor.y, tl.x, tl.y, maxZoom, placementZoom);
